...
// Wed Jun 08 15:03:25 GMT+01:00 2022
//----------------------------------------------------
...
/** jh-javacup-1.3 20220517 generated parser.
  * @version Wed Jun 08 15:03:25 GMT+01:00 2022
  */
public class Parser extends com.github.jhoenicke.javacup.runtime.LRParser {
  ...
  static com.github.jhoenicke.javacup.runtime.ParseTable CUP$parse_table =
    ...
    "\214\000\002\031\007\031\005\000\003\000\000" +
    "\012\003\006\000\006\002\001\003\001\006\002" +
    "\003\003\003\004\001\004\003\005\004\010\004" +
    "\013\004\014\004\015\004\016\005\056\000\016" +
    "\003\017\001\017\002\017\001\020\003\021\001" +
    "\022\004\023\001\023\001\023\001\024\003\025" +
    "\001\011\004\011\000\026\005\057\000\026\002" +
    "\027\003\045\002\045\000\030\002\044\002\044" +
    "\001\043\002\043\002\043\002\043\001\033\002" +
    "\035\003\035\001\036\003\037\003\037\004\040" +
    "\003\042\001\042\003\042\003\034\001\055\000" +
    ...
    "\226\001\040\157\226\001\226\001\226\001\300" +
    "\012\041\242\001\001\001\040\001\020\200\003" +
    "\016\176\235\015\000\150\047\003\040\153\010" +
    "\045\041\023\011\160\155\121\101\023\011\100" +
    "\216\024\004\117\136\130\120\016\017\076\150" +
    "\225\213\134\010\011\076\130\240\121\122\076" +
    "\124\216\012\024\025\051\150\163\034\177\070" +
    "\070\125\076\070\050\070\070\224\010\070\070" +
    "\070\071\011\151\064\007\175\073\072\177\120" +
    "\120\222\057\231\172\057\153\145\221\204\137" +
    "\127\121\067\077\010\052\071\076\127\107\107" +
    "\202\202\117\200\073\073\047\223\030\200\072" +
    "\100\203\204\077\050\174\020\203\204\030\006" +
    "\173\160\073\205\206\135\200\055\172\205\206" +
    "\022\031\031\165\203\220\221\013\162\164\163" +
    "\030\056\013\032\056\033\013\166\127\167\170" +
    "\170\171\013\103\001\104\105\105\106\013\154" +
    "\001\155\001\156\157\013\160\001\161\013\036" +
    "\037\013\113\013\014"
    });
...
static class Action$ {
  ...
  private Terminal get_term(com.github.jhoenicke.javacup.runtime.Symbol location, String id)
    {
  ...
  private NonTerminal get_nonterm(com.github.jhoenicke.javacup.runtime.Symbol location, String id)
    {
      GrammarSymbol sym = symbols.get(id);
...
parser.done_parsing();
 ...
 RESULT = grammar; 
	  ...
	  parser.options.import_list.add(id.toString());
              ...
              return parser.getSymbolFactory().newSymbol("import_spec", 10, CUP$stack.get(CUP$size - 3), CUP$stack.get(CUP$size - 1));
            }
 ...
 parser.options.setOption(opt, val); 
	  ...
	  if (parser.options.init_code!=null)
	    ...
	    parser.options.init_code = user_code;
              ...
              return parser.getSymbolFactory().newSymbol("init_code", 11, CUP$stack.get(CUP$size - 4), CUP$stack.get(CUP$size - 1));
            }
	  ...
	  if (parser.options.scan_code!=null)
	    ...
	    parser.options.scan_code = user_code;
              ...
              return parser.getSymbolFactory().newSymbol("scan_code", 12, CUP$stack.get(CUP$size - 4), CUP$stack.get(CUP$size - 1));
            }
	  ...
	  if (parser.options.after_reduce_code!=null)
	    ...
	    parser.options.after_reduce_code = user_code;
              ...
              return parser.getSymbolFactory().newSymbol("after_reduce_code", 13, CUP$stack.get(CUP$size - 4), CUP$stack.get(CUP$size - 1));
            }
 ...
 NonTerminal nt = get_nonterm(start_name$, start_name);
	   if (nt != null) 
 ...
 RESULT = w.append(" super ").append(id); 
		...
		RESULT="ILLEGAL";
              ...
              return parser.getSymbolFactory().newSymbol("robust_id", 28, e$, e$, RESULT);
            }
...
RESULT=null;
          ...
          case 67:
            {
              com.github.jhoenicke.javacup.runtime.Symbol CUP$sym = CUP$stack.get(CUP$size - 1);
              return parser.getSymbolFactory().newSymbol("prod_part*", 49, CUP$sym, CUP$sym, new java.util.ArrayList<ProductionPart>());
            }
