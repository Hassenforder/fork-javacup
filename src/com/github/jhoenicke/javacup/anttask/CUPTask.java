/**
 * com.github.jhoenicke.javacup.anttask.CUPTask.java
 *
 * @author Michael Petter, 2003
 *
 * Ant-Task for CUP Parser Generator for Java
 * -- tested with Ant 1.5.1;
 * -- compiles with javac -classpath .:${ANT_HOME}/lib/ant.jar com.github.jhoenicke.javacup.anttask.CUPTask.java
...
public class CUPTask extends Task 
{
	...
	try {
            com.github.jhoenicke.javacup.Main.main(args);
        }catch(Exception e){
